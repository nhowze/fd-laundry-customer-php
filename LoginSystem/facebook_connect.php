...
try {
    ...
    if (isset($_SESSION['facebook_access_token'])) {
        ...
        $accessToken = $helper->getAccessToken('https://'.$_SERVER['HTTP_HOST'].'/Users/LoginSystem/facebook_connect.php');
    }
            ...
            try {
               ...
               // print_r($fbUserProfile);
				...
				//do nothing
					...
					$query = "UPDATE users SET Profile_Pic = '".$pic."' WHERE username = '".$name."' ";
...
$html = file_get_html("https://".$_SERVER['HTTP_HOST']."/Users/Emails/registrationemailtemplate.php");
...
$mail->Subject    = "Welcome to ".$contactinf['Name']."! | Customer Registration";;
...
//end email 
  ...
  echo'<script>location.href = "../register.php";</script>'; 
        ...
        $loginURL = $helper->getLoginUrl('https://'.$_SERVER['HTTP_HOST'].'/Users/LoginSystem/facebook_connect.php', $fbPermissions);
